...
<html>
<head>
	<title>Pindo | Latest Collection</title>
</head>
<body class="parallax">
	<div style= "margin-top: 150px;">
		<h1 class="glow2">Latest Collection</h1>
	    <div class="container" style="color: black;">
	     	<div class="row">
	     	<?php 
		      $sql = "SELECT * FROM `latest_collections` ";
		    ...
		    ?>		
		    	 <a href="product.php?id=<?php echo $row["id"]; ?>&name=<?php echo $row["name"]; ?>&pic=<?php echo $row["image"]; ?>&price=<?php echo $row["price"]; ?>">
		          ...
		          <form method="post" action="latest.php?action=add&id=<?php echo $row["id"]; ?>">
